...

{
    ...
    cout << "Number of words: " <<
        MyString::CountWords("Mohammed Saqer Abu-Hadhoud") << endl;

    //----------------
    MyString String3("hi how are you?");
    ...
    cout << "After inverting a : "
        << MyString::InvertLetterCase('a') << endl;
    ...
    cout << "Capital Letters count : "
        << MyString::CountLetters("Mohammed Abu-Hadhoud", MyString::CapitalLetters)
        << endl << endl;
    ...
    cout << "is letter u vowel? " << MyString::IsVowel('a')
        << endl;
    ...
    cout << MyString::JoinString(vString1, " ");


    string arrString[] = { "Mohammed","Faid","Ali","Maher" };

    cout << "\n\nJoin String From array: \n";
    cout << MyString::JoinString(arrString, 4, " ");
